...
from tensor_hero.loss import custom_loss, weights_matrix
import torch
...
def main():
        ...
        weights = weights_matrix().to(device)
        ...
        for epoch in range(num_epochs):
            for batch_idx, batch in enumerate(train_loader):
                ...
                loss = custom_loss(output.permute(0,2,1), notes, pad_idx=params['pad_idx'], weights=weights, lambda_ = [150*10, 0])  # Calculate loss, this is output vs ground truth
