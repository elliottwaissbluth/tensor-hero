...
from tensor_hero.model import Transformer, Chunks, ColabChunksDataset
import torch
...
def main():
        ...
        for epoch in range(num_epochs):
            for chunk_idx in range(train_chunks.num_chunks):
                ...
                train_data = ColabChunksDataset(params['max_src_len'], params['max_trg_len'], params['pad_idx'], data_paths, labels)
                train_loader = torch.utils.data.DataLoader(train_data, **dl_params)
